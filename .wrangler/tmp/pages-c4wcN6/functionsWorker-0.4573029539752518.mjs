// ../.wrangler/tmp/bundle-R3WnkE/checked-fetch.js
...
async function onRequestPost(context) {
  ...
  const theSQL = ``;
  const info = await context.env.DB.prepare(theSQL).run();
  if (info.success == true) {
    return new Response(JSON.stringify({ status: "ok" }), { status: 200 });
  } else
    return new Response(JSON.stringify({ error: "error updating" }), { status: 400 });
}
...
// ../.wrangler/tmp/pages-c4wcN6/functionsRoutes-0.24075145633349448.mjs
var routes = [
  {
    routePath: "/api/post",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-R3WnkE/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-R3WnkE/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.4573029539752518.mjs.map
